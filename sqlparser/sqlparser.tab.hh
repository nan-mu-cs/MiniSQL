...
/**
 ** \file sqlparser.tab.hh
 ** Define the yy::parser class.
 */

// C++ LALR(1) parser skeleton written by Akim Demaille.

#ifndef YY_YY_SQLPARSER_TAB_HH_INCLUDED
# define YY_YY_SQLPARSER_TAB_HH_INCLUDED
// //                    "%code requires" blocks.
#line 8 "sqlparser.yy" // lalr1.cc:392

	#include <string>
	class sqlparser_driver &driver;

#line 49 "sqlparser.tab.hh" // lalr1.cc:392
...
namespace yy {
#line 126 "sqlparser.tab.hh" // lalr1.cc:392
  ...
  basic_symbol (typename Base::kind_type t, const subtok v, const location_type& l);
    ...
    static inline
    symbol_type
    make_COMPARISON (const subtok& v, const location_type& l);
    ...
    sqlparser (sqlparser_driver &driver;_yyarg);
    virtual ~sqlparser ();
  ...
  sqlparser::yytranslate_ (token_type t)
  {
    ...
    translate_table[] =
    {
     0,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,    47,     2,     2,     2,     2,    51,     2,
      60,    61,    54,    52,    59,    53,    58,    55,     2,     2,
  ...
  template <typename Base>
  sqlparser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const subtok v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  sqlparser::by_type::token () const
  {
    ...
    yytoken_number_[] =
    {
     ...
     295,   296,   297,   298,   299,   300,   301,    33,   302,   303,
     124,    38,    43,    45,    42,    47,   304,    59,    46,    44,
      40,    41
    };
  ...
  sqlparser::symbol_type
  sqlparser::make_DEFAULT (const location_type& l)
  {
    return symbol_type (token::DEFAULT, l);
  }

  sqlparser::symbol_type
  sqlparser::make_AUTO_INCREMENT (const location_type& l)
  {
  ...
  sqlparser::symbol_type
  sqlparser::make_UNIQUE (const location_type& l)
  {
  ...
  sqlparser::symbol_type
  sqlparser::make_COMPARISON (const subtok& v, const location_type& l)
  {
...
#line 1569 "sqlparser.tab.hh" // lalr1.cc:392




#endif // !YY_YY_SQLPARSER_TAB_HH_INCLUDED
